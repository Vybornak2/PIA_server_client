...
def generate_random_vector(length: int, min_value: float, max_value: float):
    vector = []
...
def generate_vector3(min_value: float, max_value: float):
    return generate_random_vector(3, min_value, max_value)

def generate_vector6(min_value: float, max_value: float):
